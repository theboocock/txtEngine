 ...
 * To view the txtEngine Language Specification and Documentation
 * click here: <a href="../DocumentationMain.pdf" target="_blank">
 * txtEngine Documentation</a>
 *
...
bool game_over = false; ///< Flag to end a game.
std::vector<std::string> commandList; ///< List of commands used.
std::vector<std::string> filterList; ///< List of words to filter from input.
...
/**
   ...
   @param[in] command1 First command in the form of a string.
   @param[in] command2 Second command in the form of a string.
   @return Output of the command.
*/
std::string two_word_command(std::string command1, std::string command2);

/**
   A method for handling three word commands.
   For example: combine pen paper.
 
   @param[in] command The three word command.
...
/**
   Processes input and calls the appropriate method for the number
   of words in the command. Commands are stored in the commandList
   and if too many words are in the string a feedback message is
   output. If the game is in load mode then no output is displayed.
 
   @param[in] to_process An input string to process.
   @param[in] load A flag for whether the game is in load mode.
*/
...
/**
   ...
   @param[in] file A char array - the file path to a list of words to ignore.
*/
...
/**
   ...
   @return A string containing all of the area commands.
*/
...
/**
   ...
   @param[in] temp_item A pointer to an item.
   @param[in] item An integer.
   @return The valid item commands.
*/
...
/**
   ...
   @param[in] temp_item A pointer to the item.
   @param[in] items Number of items.
   @return The valid item commands for items in the area.
*/
...
/**
   ...
   @return A string of a file path to a list of words to ignore.
*/
...
/**
   ...
   @param[in] command Input commands to be processed.
*/
...
/**
   ...
   @param[in] argc The number of command line args.
   @param[in] argv Char* array of command line args.
   @return An integer.
 */
