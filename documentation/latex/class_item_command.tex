...
\begin{DoxyCompactList}\small\item\em \-If command makes item collectable. \end{DoxyCompactList}\item 
\hypertarget{class_item_command_a6d69129934e185fbe2e8be0db40b0f94}{
bool \hyperlink{class_item_command_a6d69129934e185fbe2e8be0db40b0f94}{collect\-\_\-dependent}}
\label{class_item_command_a6d69129934e185fbe2e8be0db40b0f94}

\begin{DoxyCompactList}\small\item\em \-If command requires item to be in inventory. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\mbox{\tt in}  & {\em callmeby} & \-The command. \\
\hline
\mbox{\tt in}  & {\em state\-\_\-mutator} & \-State to change to. \\
\hline
\mbox{\tt in}  & {\em chng\-\_\-collec} & \-True if command changes item to collectable. \\
\hline
\mbox{\tt in}  & {\em collec\-\_\-dep} & \-Whether command depends on item being collected. \\
\hline
\mbox{\tt in}  & {\em area\-\_\-chng} & \-New area for item. \\
\hline
\mbox{\tt in}  & {\em status\-\_\-command} & \-Status of item after command called. \\
\hline
\mbox{\tt in}  & {\em depends} & \-What item in inventory command depends on. \\
\hline
\mbox{\tt in}  & {\em synonyms} & \-Synonyms to the command. \\
\hline
\mbox{\tt in}  & {\em unlock} & \-What the command unlocks. \\
\hline
\mbox{\tt in}  & {\em combine} & \-A boolean -\/ true if command combines items. \\
\hline
\end{DoxyParams}
